...
class HrResignation(models.Model):
    ...
    def create(self, vals):
        ...
        if vals.get('name', _('New')) == _('New'):
            vals['name'] = self.env['ir.sequence'].next_by_code('hr.employee.resignation') or _('New')
    ...
    def check_request_existence(self):
        ...
        for rec in self:
            if rec.employee_id:
                resignation_request = self.env['hr.employee.resignation'].search([('employee_id', '=', rec.employee_id.id),
    ...
    def update_employee_status(self):
        resignation = self.env['hr.employee.resignation'].search([('state', '=', 'approved')])
