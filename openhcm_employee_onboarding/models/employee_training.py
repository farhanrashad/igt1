...
class EmployeeTraining(models.Model):
    ...
    name = fields.Char(string='Employee Training Program', readonly=True, default=lambda self: _('New'))
    ...
    def print_event(self):
        ...
        return self.env.ref('openhcm_employee_onboarding.print_pack_certificates').report_action(self, data=data)
    ...
    def create(self, vals):
        vals['name'] = self.env['ir.sequence'].next_by_code('employee.training')
        result = super(EmployeeTraining, self).create(vals)
        return result
